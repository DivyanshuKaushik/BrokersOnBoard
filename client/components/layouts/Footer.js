...
export default function Footer() {
    return (
        <footer className="w-screen">
            <div className="bg-slate-700 px-10 lg:px-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:justify-items-center gap-4 py-4 lg:py-10">
                <div className="">
